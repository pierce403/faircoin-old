...
{
    int64 nSubsidy = 1 * COIN; // TODO mutiply by difficulty

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60; // FairCoin: 1 days
static const int64 nTargetSpacing = 600; // FairCoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x295e0e42a86a4a04bdb0f7794c4d6080fe5b53c6f6897ac6dca1a61dbdbe7bc1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Hooray for Potato";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389150298; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1389150298;
            block.nNonce   = 442710;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb4640dde645cd0a85930bb4048cfe364f2d2059e9be9f555c1176d67379eaaaa"));
